...
const SignupForm = () => {
    return (
        <>
            ...
            <div className="shadow-authCardShadow md:w-[400px] w-full rounded-[16px] bg-white border border-[#E5E7EB] flex flex-col items-center py-8 px-6">
                <h4 className="font-[600] font-sora text-primary text-center text-lg">Tell us about your business</h4>
                ...
                return (
                    <Form className="w-full flex flex-col gap-3 mt-6">
                        ...
                        <div className='w-full flex flex-col'>
                            <label htmlFor="business_name" className="font-poppins text-[14px] text-[#58556A] leading-[24px]">Business name</label>
                            <Field type="text" name="business_name" id="business_name" placeholder='Strimz' className={`w-full rounded-[8px] border bg-[#F9FAFB] shadow-navbarShadow h-[44px] font-poppins text-[14px] placeholder:text-[14px] placeholder:text-[#8E8C9C] text-[#8E8C9C] px-4 outline-none transition duration-300 focus:border-accent ${errors.username ? "border-red-500" : "border-[#E5E7EB]"}`} />
                            {/* error */}
