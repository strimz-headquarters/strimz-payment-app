                ...
                return (
                    <Form className="w-full flex flex-col gap-3 mt-6">
                        ...
                        <div className='w-full flex flex-col'>
                            <label htmlFor="email" className="font-poppins text-[14px] text-[#58556A] leading-[24px]">Business Email</label>
                        ...
                        <div className="w-full flex flex-col items-center gap-4 mt-8">
                            <p className="font-poppins text-center font-[400] text-[14px] text-[#58556A] leading-[24px]">Don&apos;t have an account? <Link href="/auth/business/signup" className="font-poppins font-[600] text-[14px] text-accent hover:underline leading-[24px]">Sign Up</Link>
                            </p>
