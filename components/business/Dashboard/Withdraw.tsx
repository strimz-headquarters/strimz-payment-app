    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <button
                    type="button"
                    className={`w-[97px] h-[32px] flex justify-center items-center bg-gradient-to-b from-[#02C76A] to-[#00A859] rounded-[8px] shadow-[0px_-3px_2.7px_0px_#029751_inset] cursor-pointer text-[12px] font-[500] font-poppins text-white`}
                >
                    Withdraw
                </button>
            </DialogTrigger>
